    ...
    <table class="table">
        ...
        @foreach($all_claims as $key=>$single_data)
            <tr>
                ...
                <td>
                    <a href="{{route('claim.approved',$single_data->id)}}" class="btn btn-success">Approve</a>
                    <a href="{{route('claim.reject',$single_data->id)}}" class="btn btn-success">Reject</a>
                </td>
                @endif
